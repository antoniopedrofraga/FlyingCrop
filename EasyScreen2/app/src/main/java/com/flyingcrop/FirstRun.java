...
public class FirstRun extends Service {
    ...
    public void onCreate() {
        ...
        text.setText("Grab any screen on your android device!");
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(i == 1){
                    ...
                    text.setText("Share it with everyone in social media!");
                    ...
                    text.setText("Be an artist and paint it!");
                    wm.updateViewLayout(text, text_params);
                    wm.updateViewLayout(image, image_params);
                }else if (i == 2){
                    image.setBackground(getResources().getDrawable(R.drawable.customize));
                    text.setText("Customize it at your one way, just explore the \"Settings\" section!");
                    next.setText("Got it");
                    wm.updateViewLayout(text, text_params);
                    wm.updateViewLayout(image, image_params);
