 ...
 */
public class FirstCrop extends Service {
    WindowManager wm;
    Button overlay;
    Button next;
    TextView text;
    ...
    public void onCreate() {
        ...
        text.setText("Drag arround to select the crop area");
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(i == 0){
                    image.setBackground(getResources().getDrawable(R.drawable.second_crop));
                    text.setText("We recommend to select \"Don't show again\" on the Media Projection dialog, otherwise this dialog will appear on the taken screenshot");
                    next.setText("Got it");
                    ...
                    editor.putBoolean("first_crop", false);
                    editor.commit();
                    Intent serviceIntent = new Intent(getApplicationContext(), Crop.class);
        ...
        image.setBackground(getResources().getDrawable(R.drawable.first_crop));
