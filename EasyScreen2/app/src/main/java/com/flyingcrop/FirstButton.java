 ...
 */
public class FirstButton extends Service {
    WindowManager wm;
    Button overlay;
    Button next;
    TextView text;
    ...
    public void onCreate() {
        ...
        text.setText("You can drag the button anywhere on the screen and it will close if at the center");
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(i == 0){
                    image.setBackground(getResources().getDrawable(R.drawable.second_button));
                    text.setText("Click on the button to open the brush tool");
                    next.setText("Got it");
                    ...
                    editor.putBoolean("first_button", false);
                    editor.commit();
        ...
        image.setBackground(getResources().getDrawable(R.drawable.first_button3));
