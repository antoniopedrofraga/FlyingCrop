 ...
 */
public class FirstRun extends Service {
    WindowManager wm;
    Button overlay;
    Button next;
    TextView text;
    ...
    public void onCreate() {
        ...
        text.setText(getResources().getString(R.string.first_run_first));
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(i == 1){
                    image.setBackground(getResources().getDrawable(R.drawable.social_media));
                    text.setText(getResources().getString(R.string.first_run_third));
                    wm.updateViewLayout(text, text_params);
                    wm.updateViewLayout(image, image_params);
                }else if (i == 0){
                    image.setBackground(getResources().getDrawable(R.drawable.paint_first));
                    text.setText(getResources().getString(R.string.first_run_second));
                    wm.updateViewLayout(text, text_params);
                    wm.updateViewLayout(image, image_params);
                }else if (i == 2){
                    image.setBackground(getResources().getDrawable(R.drawable.customize));
                    text.setText(getResources().getString(R.string.first_run_fourth));
                    ...
                    editor.putBoolean("first_help", false);
                    editor.commit();
                    stopSelf();
                }
                i++;
        ...
        image.setBackground(getResources().getDrawable(R.drawable.phone_tablet));
